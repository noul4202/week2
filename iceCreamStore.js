...
let bestMenu = Object.keys(flavorDistribution).reduce((a, b) => flavorDistribution[a] > flavorDistribution[b] ? a : b);

console.log(`Best selling flavor is ${bestMenu}`); // Best selling flavor is Vanilla